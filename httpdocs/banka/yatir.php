...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $yatirmaMiktar = isset($_POST['yatirmaMiktar']) ? floatval($_POST['yatirmaMiktar']) : 0;
    ...
    if ($yatirmaMiktar > 0) {
     ...
     $sql = "UPDATE kullanicilar SET banka = banka + $yatirmaMiktar, para = para - $yatirmaMiktar WHERE id = $kullanici_id";
