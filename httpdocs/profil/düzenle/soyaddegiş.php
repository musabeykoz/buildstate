...
$newSurname = $conn->real_escape_string($_POST['newName']);

// Soyad değiştirme ücreti
$elmasMiktari = 250;
...
if ($kontrolResult->num_rows > 0) {
    ...
    if ($mevcutElmas >= $elmasMiktari) {
        // Elmas yeterli, soyadı güncelle ve elması düş
        $updateQuery = "UPDATE kullanicilar SET soyad = '$newSurname', elmas = elmas - $elmasMiktari WHERE id = $kullanici_id";
